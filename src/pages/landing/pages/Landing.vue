<template>
  <div>
    <LandingNavbar :colorOnScroll="this.colorOnScrollLanding"></LandingNavbar>
    <div class="page-header page-header-small">
      <parallax class="page-header-image" style="background-image: url('img/bg6.jpg')"></parallax>
      <div class="content-center">
        <div class="container">
          <h1 class="title">Joobis, o novo método empregativo</h1>
          <div class="text-center">
            <a
              href="#"
              class="btn orange-btn btn-icon btn-round"
            >
    ...
    <div class="section section-about-us" id="Teste">
      <div class="container">
        <div class="row">
    ...
    <landing-footer backgroundColor="black" />
  </div>
</template>
<script>
...
import { Button, FormGroupInput } from "@/components/LandingPage";
export default {
  name: "landing",
